...
it('can log activity using a custom model', function () {
    app()['config']->set('history-tracking.activity_model', Activity::class);
...
it('does not throw an exception when model config is null', function () {
    app()['config']->set('history-tracking.activity_model', null);
...
it('throws an exception when model doesnt implements activity', function () {
    app()['config']->set('history-tracking.activity_model', InvalidActivity::class);
...
it('throws an exception when model doesnt extend model', function () {
    app()['config']->set('history-tracking.activity_model', AnotherInvalidActivity::class);
